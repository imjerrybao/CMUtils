...
+ (NSArray *) clusterAnnotationsForMapView:(MKMapView *)mapView forAnnotations:(NSArray *)pins blocks:(NSUInteger)blocks minClusterLevel:(NSUInteger)minClusterLevel minvisibleAnnotations:(NSUInteger)minVisiable
{
    ...
    if( zoomLevel > minClusterLevel || visibleAnnotations.count < minVisiable)
    {
...
{
    return [self clusterAnnotationsForMapView:mapView forAnnotations:pins blocks:BLOCKS minClusterLevel:MINIMUM_CLUSTER_LEVEL minvisibleAnnotations:0];
}
