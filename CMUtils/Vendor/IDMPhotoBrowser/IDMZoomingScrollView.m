...
- (void)setProgress:(CGFloat)progress forPhoto:(IDMPhoto*)photo {
    ...
    if (photo.photoURL && [photo.photoURL.absoluteString isEqualToString:p.photoURL.absoluteString]) {
        if (_progressView.progress < progress) {
            [_progressView setProgress:progress animated:YES];
        }
    }
    else if (photo.imageId && [photo.imageId isEqualToString:p.imageId]) {
        if (_progressView.progress < progress) {
            [_progressView setProgress:progress animated:YES];
        }
    }
