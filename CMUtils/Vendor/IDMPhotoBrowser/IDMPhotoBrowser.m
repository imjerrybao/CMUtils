...
- (id)initWithImageIds:(NSArray *)ImageIdsArray {
    if ((self = [self init])) {
        NSArray *photosArray = [IDMPhoto photosWithImageIds:ImageIdsArray];
        _photos = [[NSMutableArray alloc] initWithArray:photosArray];
    }
    return self;
}

- (id)initWithImageIds:(NSArray *)ImageIdsArray animatedFromView:(UIView*)view{
    if ((self = [self init])) {
        NSArray *photosArray = [IDMPhoto photosWithImageIds:ImageIdsArray];
        _photos = [[NSMutableArray alloc] initWithArray:photosArray];
...
- (void)toggleControls    { [self doneButtonPressed:_doneButton]; }
